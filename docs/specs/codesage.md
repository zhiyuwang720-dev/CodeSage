...
| 13 | `feat/13-subagents` | 子代理 | agent 定义(frontmatter 解析 + 优先级合并)、Task 工具、forkContext、前/后台(#15) | 子代理 + 单测 |
| 14 | `feat/14-skills` | 技能系统 | skill 发现/加载/契约、allowed_tools、斜杠命令机制 | 技能 + 单测 |
