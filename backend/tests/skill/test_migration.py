...
def test_load_agent_bindings_reads_primary_bindings_file(tmp_path):
    ...
    bindings_file = library_root / "agents" / "review-security" / "bindings.json"
    ...
    bindings = load_agent_bindings(library_root=library_root, agent_type="review:security")
...
def test_load_agent_bindings_synthesizes_missing_entries_from_legacy_mirror_binding(tmp_path):
    library_root = tmp_path / "skill_library"
    mirror_dir = library_root / "agents" / "review-security" / "gamma"
