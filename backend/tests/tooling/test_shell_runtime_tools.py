...
from app.node_runtime.tool_gateway.permission.guardrails import register_shell_approval
from app.node_runtime.tool_gateway.shell import (
    BashRuntimeTool,
    BashToolInput,
...
def test_bash_runtime_tool_executes_with_backend_tool_when_present(monkeypatch):
    monkeypatch.setattr("app.node_runtime.tool_gateway.shell.detect_bash_executable", lambda: None)
