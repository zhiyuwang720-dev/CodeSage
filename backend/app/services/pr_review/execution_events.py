...
from app.services.pr_review.results import ReviewResultService, review_result_service
    ...
    *,
    ...
    async def sink(event: dict[str, Any]) -> None:
        ...
        if event_type == "meta":
            ...
            async with lock:
                await result_service.touch_session(
                    db, task_id, perspective, str(event["session_id"])
                )
