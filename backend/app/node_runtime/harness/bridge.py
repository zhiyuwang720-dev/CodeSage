...
from app.node_runtime.llm.config import resolve_tool_message_format
...
class RuntimeBridge:
    ...
    async def _ensure_payload(
        ...
        *,
        ...
        finalizer_registry = ToolRegistry(finalizer_tools or [])
    ...
    def _build_tool_registry(
        self,
        tool_allowlist: set[str] | None = None,
        terminal_tools: list[Any] | None = None,
    ) -> ToolRegistry:
