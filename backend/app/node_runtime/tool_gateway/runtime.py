...
from app.node_runtime.persistence.models import AuditCheckpointType, ToolExecutionReceiptStatus
...
from app.node_runtime.tool_gateway.permission.runtime import RuntimePermissionRuntime, ToolPermissionDecision
...
ToolOrchestrator = ToolGateway  # compatibility alias for external extensions
