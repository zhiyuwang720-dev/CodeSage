...
from app.node_runtime.tool_gateway.runtime import RuntimeTool, ToolRegistry
...
from app.node_runtime.tool_gateway.write import WriteRuntimeTool
...
def build_runtime_tool_registry(
    *,
    ...
    terminal_tools: list[RuntimeTool] | None = None,
) -> ToolRegistry:
    ...
    tools.extend(terminal_tools or [])
    tools.extend(
        [
    ...
    if tool_allowlist is not None:
        ...
        allow = set(tool_allowlist) | {tool.name for tool in terminal_tools or []}
